...
class ReactiveQueryConfig {
    ...
    class ReactivePersistenceInfo(persistenceUnitInfo: PersistenceUnitInfo, jpaPropertyMap: Map<String, Any>) :
        ...
        private val internalProps = Properties(persistenceUnitInfo.properties).apply {
            ...
            setProperty(Settings.SQL_CLIENT_POOL, DbConnectionPool::class.qualifiedName)
            setProperty(Settings.SQL_CLIENT_POOL_CONFIG, VertxDBConnectionPoolConfiguration::class.qualifiedName)
