...
open class GetCustomerBalance : AbstractRoutine<BigDecimal>("get_customer_balance", Sakila.SAKILA, SQLDataType.DECIMAL(5, 2)) {
    companion object {
     ...
     */
    fun setPCustomerId(field: Field<Int?>): GetCustomerBalance {
     ...
     */
    fun setPEffectiveDate(field: Field<LocalDateTime?>): GetCustomerBalance {
