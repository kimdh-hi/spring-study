...
open class CustomerDao(configuration: Configuration?) : DAOImpl<CustomerRecord, Customer, Long>(JCustomer.CUSTOMER, Customer::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJCustomerId(lowerInclusive: Long?, upperInclusive: Long?): List<Customer> = fetchRange(JCustomer.CUSTOMER.CUSTOMER_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>customer_id IN (values)</code>
     */
    fun fetchByJCustomerId(vararg values: Long): List<Customer> = fetch(JCustomer.CUSTOMER.CUSTOMER_ID, *values.toTypedArray())

    /**
     * Fetch a unique record that has <code>customer_id = value</code>
     */
    fun fetchOneByJCustomerId(value: Long): Customer? = fetchOne(JCustomer.CUSTOMER.CUSTOMER_ID, value)

    /**
     * Fetch records that have <code>store_id BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    fun fetchRangeOfJStoreId(lowerInclusive: Long?, upperInclusive: Long?): List<Customer> = fetchRange(JCustomer.CUSTOMER.STORE_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>store_id IN (values)</code>
     */
    fun fetchByJStoreId(vararg values: Long): List<Customer> = fetch(JCustomer.CUSTOMER.STORE_ID, *values.toTypedArray())
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJAddressId(lowerInclusive: Long?, upperInclusive: Long?): List<Customer> = fetchRange(JCustomer.CUSTOMER.ADDRESS_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>address_id IN (values)</code>
     */
    fun fetchByJAddressId(vararg values: Long): List<Customer> = fetch(JCustomer.CUSTOMER.ADDRESS_ID, *values.toTypedArray())
