...
open class CityDao(configuration: Configuration?) : DAOImpl<CityRecord, City, Long>(JCity.CITY, City::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJCityId(lowerInclusive: Long?, upperInclusive: Long?): List<City> = fetchRange(JCity.CITY.CITY_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>city_id IN (values)</code>
     */
    fun fetchByJCityId(vararg values: Long): List<City> = fetch(JCity.CITY.CITY_ID, *values.toTypedArray())

    /**
     * Fetch a unique record that has <code>city_id = value</code>
     */
    fun fetchOneByJCityId(value: Long): City? = fetchOne(JCity.CITY.CITY_ID, value)
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJCountryId(lowerInclusive: Long?, upperInclusive: Long?): List<City> = fetchRange(JCity.CITY.COUNTRY_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>country_id IN (values)</code>
     */
    fun fetchByJCountryId(vararg values: Long): List<City> = fetch(JCity.CITY.COUNTRY_ID, *values.toTypedArray())
