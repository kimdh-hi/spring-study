...
open class PaymentDao(configuration: Configuration?) : DAOImpl<PaymentRecord, Payment, Long>(JPayment.PAYMENT, Payment::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJPaymentId(lowerInclusive: Long?, upperInclusive: Long?): List<Payment> = fetchRange(JPayment.PAYMENT.PAYMENT_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>payment_id IN (values)</code>
     */
    fun fetchByJPaymentId(vararg values: Long): List<Payment> = fetch(JPayment.PAYMENT.PAYMENT_ID, *values.toTypedArray())

    /**
     * Fetch a unique record that has <code>payment_id = value</code>
     */
    fun fetchOneByJPaymentId(value: Long): Payment? = fetchOne(JPayment.PAYMENT.PAYMENT_ID, value)

    /**
     * Fetch records that have <code>customer_id BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    fun fetchRangeOfJCustomerId(lowerInclusive: Long?, upperInclusive: Long?): List<Payment> = fetchRange(JPayment.PAYMENT.CUSTOMER_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>customer_id IN (values)</code>
     */
    fun fetchByJCustomerId(vararg values: Long): List<Payment> = fetch(JPayment.PAYMENT.CUSTOMER_ID, *values.toTypedArray())

    /**
     * Fetch records that have <code>staff_id BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    fun fetchRangeOfJStaffId(lowerInclusive: Long?, upperInclusive: Long?): List<Payment> = fetchRange(JPayment.PAYMENT.STAFF_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>staff_id IN (values)</code>
     */
    fun fetchByJStaffId(vararg values: Long): List<Payment> = fetch(JPayment.PAYMENT.STAFF_ID, *values.toTypedArray())
