...
open class FilmDao(configuration: Configuration?) : DAOImpl<FilmRecord, Film, Long>(JFilm.FILM, Film::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJFilmId(lowerInclusive: Long?, upperInclusive: Long?): List<Film> = fetchRange(JFilm.FILM.FILM_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>film_id IN (values)</code>
     */
    fun fetchByJFilmId(vararg values: Long): List<Film> = fetch(JFilm.FILM.FILM_ID, *values.toTypedArray())

    /**
     * Fetch a unique record that has <code>film_id = value</code>
     */
    fun fetchOneByJFilmId(value: Long): Film? = fetchOne(JFilm.FILM.FILM_ID, value)
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJLanguageId(lowerInclusive: Long?, upperInclusive: Long?): List<Film> = fetchRange(JFilm.FILM.LANGUAGE_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>language_id IN (values)</code>
     */
    fun fetchByJLanguageId(vararg values: Long): List<Film> = fetch(JFilm.FILM.LANGUAGE_ID, *values.toTypedArray())

    /**
     * Fetch records that have <code>original_language_id BETWEEN lowerInclusive
     * AND upperInclusive</code>
     */
    fun fetchRangeOfJOriginalLanguageId(lowerInclusive: Long?, upperInclusive: Long?): List<Film> = fetchRange(JFilm.FILM.ORIGINAL_LANGUAGE_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>original_language_id IN (values)</code>
     */
    fun fetchByJOriginalLanguageId(vararg values: Long): List<Film> = fetch(JFilm.FILM.ORIGINAL_LANGUAGE_ID, *values.toTypedArray())

    /**
     * Fetch records that have <code>rental_duration BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    fun fetchRangeOfJRentalDuration(lowerInclusive: Int?, upperInclusive: Int?): List<Film> = fetchRange(JFilm.FILM.RENTAL_DURATION, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>rental_duration IN (values)</code>
     */
    fun fetchByJRentalDuration(vararg values: Int): List<Film> = fetch(JFilm.FILM.RENTAL_DURATION, *values.toTypedArray())
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJLength(lowerInclusive: Int?, upperInclusive: Int?): List<Film> = fetchRange(JFilm.FILM.LENGTH, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>length IN (values)</code>
     */
    fun fetchByJLength(vararg values: Int): List<Film> = fetch(JFilm.FILM.LENGTH, *values.toTypedArray())
