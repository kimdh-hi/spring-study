...
open class FilmText(
    ...
    companion object {
         ...
         */
        val FILM_TEXT: FilmText = FilmText()
    }
    ...
    override fun `as`(alias: String): FilmText = FilmText(DSL.name(alias), this)
    override fun `as`(alias: Name): FilmText = FilmText(alias, this)
    override fun `as`(alias: Table<*>): FilmText = FilmText(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): FilmText = FilmText(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): FilmText = FilmText(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): FilmText = FilmText(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition): FilmText = FilmText(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): FilmText = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition): FilmText = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>): FilmText = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): FilmText = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): FilmText = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): FilmText = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): FilmText = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): FilmText = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): FilmText = where(DSL.notExists(select))
}
