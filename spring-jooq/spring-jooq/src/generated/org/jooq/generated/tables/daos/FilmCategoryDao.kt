...
open class FilmCategoryDao(configuration: Configuration?) : DAOImpl<FilmCategoryRecord, FilmCategory, Record2<Long?, Long?>>(JFilmCategory.FILM_CATEGORY, FilmCategory::class.java, configuration) {
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfJFilmId(lowerInclusive: Long?, upperInclusive: Long?): List<FilmCategory> = fetchRange(JFilmCategory.FILM_CATEGORY.FILM_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>film_id IN (values)</code>
     */
    fun fetchByJFilmId(vararg values: Long): List<FilmCategory> = fetch(JFilmCategory.FILM_CATEGORY.FILM_ID, *values.toTypedArray())

    /**
     * Fetch records that have <code>category_id BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    fun fetchRangeOfJCategoryId(lowerInclusive: Long?, upperInclusive: Long?): List<FilmCategory> = fetchRange(JFilmCategory.FILM_CATEGORY.CATEGORY_ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>category_id IN (values)</code>
     */
    fun fetchByJCategoryId(vararg values: Long): List<FilmCategory> = fetch(JFilmCategory.FILM_CATEGORY.CATEGORY_ID, *values.toTypedArray())
