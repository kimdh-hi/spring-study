 ...
 */
inline fun org.gradle.api.tasks.testing.Test.`systemProperties`(vararg `properties`: Pair<String, Any?>): org.gradle.api.tasks.testing.Test =
 ...
 */
inline fun org.gradle.api.tasks.testing.Test.`environment`(vararg `environmentVariables`: Pair<String, Any?>): org.gradle.api.tasks.testing.Test =
