...
/**
 * The builtin Gradle plugin implemented by [org.gradle.plugin.devel.plugins.ExternalPluginValidationPlugin].
 *
 * @see org.gradle.plugin.devel.plugins.ExternalPluginValidationPlugin
 */
inline val org.gradle.plugin.use.PluginDependenciesSpec.`validate-external-gradle-plugin`: org.gradle.plugin.use.PluginDependencySpec
    get() = id("org.gradle.validate-external-gradle-plugin")
